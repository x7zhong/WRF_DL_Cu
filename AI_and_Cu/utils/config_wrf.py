...
# config_wrf.label_single_height_variable = ['trigger']
...
config_wrf.error_train = ['mae_trigger']
...
if 'trigger' in config_wrf.label_all_variable:
    ...
    if len(config_wrf.label_all_variable) == 1:
        ...
        config_wrf.error_train = ['BCE' , 'mae_trigger']    
        
config_wrf.weight_loss = {}
for varName in config_wrf.label_all_possible_variable:
    config_wrf.weight_loss[varName] = 1    
    
if ('mse' in config_wrf.error_train) | ('mse_trigger' in config_wrf.error_train):
    config_wrf.weight_loss['nca'] = 1*10**4
    config_wrf.weight_loss['pratec'] = 1*10**2
    config_wrf.weight_loss['rthcuten'] = 1*10**3
    config_wrf.weight_loss['rqvcuten'] = 1*10**3
    config_wrf.weight_loss['rqccuten'] = 1*10**3
    config_wrf.weight_loss['rqrcuten'] = 1*10**2
    config_wrf.weight_loss['rqicuten'] = 1*10**4
    config_wrf.weight_loss['rqscuten'] = 1*10**5
    
elif ('mae' in config_wrf.error_train) | ('mae_trigger' in config_wrf.error_train):
    
    config_wrf.weight_loss['nca'] = 1*10**2    
    if 'mae_trigger' in config_wrf.error_train:
        config_wrf.weight_loss['nca'] = 1*10**1
    
    config_wrf.weight_loss['pratec'] = 1*10**1
    config_wrf.weight_loss['rthcuten'] = 1*10**1
    config_wrf.weight_loss['rqvcuten'] = 1*10**1
    config_wrf.weight_loss['rqccuten'] = 1*10**1
    config_wrf.weight_loss['rqrcuten'] = 1*10**1
    config_wrf.weight_loss['rqicuten'] = 1*10**1
    config_wrf.weight_loss['rqscuten'] = 1*10**4
...
#if_save specify whether save the DL model output for testing data
# config_wrf.if_save = False
config_wrf.if_save = True
